                        ...
                        >
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-[5px]">
                                    ...
                                    <StatusUser :is-active="true" />
                                </div>

                                <div class="line-clamp-2">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Culpa assumenda, excepturi
                                    vel non facere commodi delectus ipsam
                                    explicabo quaerat rem aspernatur placeat
                                    nobis veritatis quas quibusdam officia illum
                                    fugiat voluptatem?
                                </div>
                            </div>
            ...
            <div class="w-[220px]">
                <div class="rounded-[10px] bg-[#5b595b] p-[15px] shadow-xl">
                    ...
                    <div class="mt-[10px] flex justify-between">
                        <div
                            class="h-[30px] w-[30px] rounded-[10px] bg-purple-500"
                        />
                        <div
                            class="h-[30px] w-[30px] rounded-[10px] bg-purple-500"
                        />
                ...
                <div class="mt-[10px] flex flex-col gap-[10px]">
                    <div class="h-[60px] w-full rounded-[10px] bg-gray-400" />
                    <div class="h-[60px] w-full rounded-[10px] bg-gray-400" />
                    <div class="h-[60px] w-full rounded-[10px] bg-gray-400" />
                    <div class="h-[60px] w-full rounded-[10px] bg-gray-400" />
                </div>
