...
<template>
    <div>
        <BackDrop>
            <div>
                ...
                <div ref="boxRef"
                    ...
                    <div :class="clsx('relative w-[300px] bg-white text-[0.9rem]', { 'w-[500px]': isHasFile })">
                        <div class="absolute right-[12px] top-[12px]">
                            <div class="relative h-[18px] w-[18px] rounded-full bg-gray-600 cursor-pointer"
                                @click="closePostBox">
                                <div
        ...
        <span data-lexical-text="true">asdfdsfaa</span> -->
                        ...
                        ">
                            <svg v-if="isHasFile" aria-label="Open Media Gallery" class="_ab6-" color="#ffffff"
                                fill="#ffffff" height="16" role="img" viewBox="0 0 24 24" width="16">
                                <path
                            ...
                            <svg v-if="!isHasFile" aria-label="Icon to represent media such as images or videos"
