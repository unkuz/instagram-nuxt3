...
<template>
  <div class="absolute bottom-[15px] left-[15px] right-[100px] duration-200 md:bottom-[50px]">
    <div class="flex items-center gap-[20px]">
      <NuxtLink :to="`/${user?.user_name}/`"><Avatar :size="SizeAvatarEnum.S" :url="user?.profile_pic_url" /></NuxtLink>
    ...
    <p class="mt-[10px] line-clamp-1 whitespace-pre-line text-c1 md:mt-[20px] [&>a]:text-c7 dark:[&>a]:text-c15">
      {{ $urlify(caption) }}
    </p>
  </div>
</template>
