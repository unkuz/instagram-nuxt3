...
<template>
  <div class="absolute bottom-[60px] left-[10px] right-[10px] duration-200 md:bottom-[20px]">
    ...
    <p
      class="mt-[10px] whitespace-pre-line line-clamp-1 md:mt-[20px] [&>a]:text-c7 dark:[&>a]:text-c15"
