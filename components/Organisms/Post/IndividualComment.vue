  ...
  <div class="mb-[10px]" :id="`post_detail_${comment.id}`">
    <div class="relative my-[4px] rounded-md">
      ...
      <div class="ml-[52px] -translate-y-[3px] pr-[10px]">
        <p>{{ comment.text }}</p>
        <div class="flex gap-[10px] text-[0.8rem]">
      ...
      <div class="absolute top-0 left-0 h-[85%] w-[3px] -translate-x-[0px] bg-c14"></div>
    </div>
    <div
    ...
    >
      ...
      <div class="absolute top-0 left-0 h-[85%] w-[3px] -translate-x-[0px] bg-c12"></div>
    </div>
  </div>
</template>
