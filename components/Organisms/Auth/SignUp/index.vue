  ...
  >
    <div class="flex h-full w-full items-center justify-between">
      <div class="relative h-full w-[90%] bg-transparent">
        <p
          class="absolute -top-[8px] bottom-1/2 translate-y-1/2 opacity-50"
          ref="placeHolderUsernameRef"
        >
          Username
        </p>
        <input
      ...
      <div>
        ...
        >
          ...
          <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            <g id="System" transform="translate(-144.000000, -48.000000)" fill-rule="nonzero">
              <g id="check_circle_fill" transform="translate(144.000000, 48.000000)">
                <path
