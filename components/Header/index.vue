...
<template>
    ...
    >
        ...
        >
            <div
                class="flex w-full items-center gap-[22px] md:w-auto lg:w-full"
            >
                <Logo />
                <div @click="toggleShowExtension">
                    <Flashicon_
                        class="cursor-pointer dark:[&>path]:fill-white"
                    />
                </div>
                <!-- <DarkMode /> -->
            ...
            >
                ...
                <div
                    v-show="!isMobile"
                    @click="handleSelect(SectionEnum.REELS)"
                >
                    <NuxtLink to="/reels">
                ...
                <div
                    class="relative"
                    @click="handleSelect(SectionEnum.NEW_POST)"
                >
                    <NewPost :is-select="section === SectionEnum.NEW_POST" />
                </div>
                <div
                    v-show="!isMobile"
                    @click="handleSelect(SectionEnum.FINDPEOPLE)"
                >
                    <NuxtLink to="/explore/">
                        <FindPeople
                            :is-select="section === SectionEnum.FINDPEOPLE"
                        />
                    </NuxtLink>
                </div>
                <div
                ...
                >
                    ...
                    <div ref="activityFeedPopRef">
                        <ActivityFeedPop
                            v-show="section === SectionEnum.ACTIVITYFEED"
                        />
                    </div>
                </div>
                <div
