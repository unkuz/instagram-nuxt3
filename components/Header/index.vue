...
<template>
  <header
    class="fixed top-0 left-0 z-10 h-[60px] w-screen border-c4 bg-c1/80 shadow-c4 backdrop-blur-[5px] dark:border-none dark:bg-c19/80 dark:shadow-none md:border-b-[1px] md:shadow-sm"
  >
    <div
