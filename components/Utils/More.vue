...
<template>
    <div class="z-50">
        <BackDrop>
            <div class="fixed right-1/2 -bottom-[100%] z-20 w-[85%] translate-x-1/2 text-[0.8rem] sm:w-[400px]"
                ref="moreRef">
                <div
                    class="flex h-[60px] items-center justify-between rounded-[0.8rem] bg-white px-[20px] sm:px-[30px]">
                    <div class="flex items-center space-x-[20px]">
                        <Avatar url="/personal/284244344_5311122635605193_5864440318105391567_n.jpg"
                            className="w-[45px]" />
                        <div>
                            <p>Joe Biden</p>
                            <p>View Profile</p>
                ...
                <div class="mt-[10px] overflow-hidden rounded-[0.8rem] bg-white">
                    <div v-for="(i, idx) in options" :key="idx"
