...
const updateTime = () => {
    Object.assign(barRef!.style, {
        width: `${
            (videoRef!.currentTime * containerBar!.clientWidth) /
            videoRef!.duration
        }px`,
    })
        ...
        <BackDrop>
            ...
            >
                ...
                <div class="mx-auto w-[90%] sm:w-[445px]">
                    <div
                        class="mt-[25px] flex w-full justify-between space-x-2"
                    >
                        <div
                            ref="containerBar"
                    ...
                    <div
                        class="relative mt-[10px] flex items-center justify-between"
                    >
                        <div
                            class="flex items-center space-x-[10px] text-[0.8rem] text-white"
                        >
                            <div
                                class="h-[35px] w-[35px] rounded-[50%] bg-white"
                            />
                            <div>cuzknothz</div>
