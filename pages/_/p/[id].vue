...
import Carousel from '@/components/Organisms/Feed/List/Carousel.vue'
import Comment from '@/components/Organisms/Feed/List/Comment.vue'
import Head from '@/components/Organisms/Feed/List/Head.vue'
import IndividualComment from '@/components/Organisms/Feed/List/IndividualComment.vue'
import LikeCommentCount from '@/components/Organisms/Feed/List/LikeCommentCount.vue'
