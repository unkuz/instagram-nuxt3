...
<template>
  <div class="text-sm">
    ...
    <div class="mt-[20px] flex justify-around">
      <svg v-if="currentSelect == SELECT_TYPE.ALL" @click="profileStore.setSelect(SELECT_TYPE.ALL)" aria-label="Posts"
        class="cursor-pointer" color="#0095f6" fill="#0095f6" height="24" role="img" viewBox="0 0 24 24" width="24">
      ...
      <svg v-else @click="profileStore.setSelect(SELECT_TYPE.ALL)" aria-label="Posts" class="cursor-pointer"
        color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
        <rect fill="none" height="18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
          stroke-width="2" width="18" x="3" y="3"></rect>
        <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          x1="9.015" x2="9.015" y1="3" y2="21"></line>
      ...
      <svg v-if="currentSelect == SELECT_TYPE.REELS" @click="profileStore.setSelect(SELECT_TYPE.REELS)"
        aria-label="Reels" class="cursor-pointer" color="#0095f6" fill="#0095f6" height="24" role="img"
      ...
      <svg v-else @click="profileStore.setSelect(SELECT_TYPE.REELS)" aria-label="Reels" class="cursor-pointer"
        color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
        <line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="2.049" x2="21.95"
          y1="7.002" y2="7.002"></line>
        <line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <svg v-if="currentSelect == SELECT_TYPE.TAG" @click="profileStore.setSelect(SELECT_TYPE.TAG)" aria-label="Tagged"
        class="cursor-pointer" color="#0095f6" height="24" role="img" viewBox="0 0 24 24" width="24">
        <path
      ...
      <svg v-else @click="profileStore.setSelect(SELECT_TYPE.TAG)" aria-label="Tagged" class="cursor-pointer"
        color="#8e8e8e" fill="#8e8e8e" height="24" role="img" viewBox="0 0 24 24" width="24">
        <path
          d="M10.201 3.797L12 1.997l1.799 1.8a1.59 1.59 0 001.124.465h5.259A1.818 1.818 0 0122 6.08v14.104a1.818 1.818 0 01-1.818 1.818H3.818A1.818 1.818 0 012 20.184V6.08a1.818 1.818 0 011.818-1.818h5.26a1.59 1.59 0 001.123-.465z"
          fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path>
    ...
    <div class="mt-[20px] grid grid-cols-3 gap-[5px]">
      <img src="/personal/284244344_5311122635605193_5864440318105391567_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/271827299_648555502866475_6120779624187626708_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/271827299_648555502866475_6120779624187626708_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/285912787_394288332653847_7603823348223049999_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/286080936_5042279369231267_5247065737773824167_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/286156153_1180787169352168_8777747362582813059_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/285912787_394288332653847_7603823348223049999_n.jpg"
        class="aspect-square w-full object-cover" />
      <img src="/personal/286080936_5042279369231267_5247065737773824167_n.jpg"
